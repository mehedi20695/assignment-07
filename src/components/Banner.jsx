...
const Banner = ({ handleAddCoins }) => {
    return (
        <div className="bg-cover bg-black text-center space-y-5 rounded-lg" style={{ backgroundImage: `url("../../assets/bg-shadow.png")` }}>
            ...
            <div className="pb-10">
                <span className='px-2 py-5 border border-[#E7FE29] rounded-xl'>
                    <button onClick={handleAddCoins} className="btn font-bold bg-[#E7FE29] shadow-black">Claim Free Credit</button>
                </span>
            </div>
        </div>
    );
